...
public:
    ...
    // Time-stepping -----------------------------------------------------------
    void compute_rhs (amrex::MultiFab& S, amrex::MultiFab& dSdt, amrex::Real dt, amrex::FluxRegister* fr_as_crse, amrex::FluxRegister* fr_as_fine);
